...
function [x,fval,exitflag,output,lambda] = fcn_gurobilp(f,A,b,Aeq,beq,lb,ub,x0,options)
%Copyright 2020, Gurobi Optimization, LLC
%
%FCN_GUROBILP A linear programming example using the Gurobi MATLAB interface
%
...
if isfield(options,'OutOfMemory')
    params.PreSparsify = true;
    params.Method = 0;
    params.Threads = 4;
end
