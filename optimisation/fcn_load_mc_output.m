...
a1_landuse_chg = fcn_landuse_chg_a1();
...
% Load cost/benefit predictions for the Baseline model
afforestation1 = readtable([tables_path, 'a1_', optim_object.baseline_run, '.csv']);
optim_object.baseline = afforestation1;
optim_object.baseline.hectares = a1_landuse_chg.wood_ha_chg;
end